...
func (a *AlertManager) sendSlack(event AlertEvent) {
	...
	resp, err := http.Post(a.cfg.SlackWebhook, "application/json", bytes.NewBuffer(body))
	if err != nil {
...
func (a *AlertManager) sendEmail(event AlertEvent) {
	...
	msg := []byte("To: " + strings.Join(a.cfg.EmailTo, ",") + "\r\n" +
		"Subject: " + subject + "\r\n\r\n" + body + "\r\n")
	if err := smtp.SendMail(a.cfg.EmailSMTP, nil, a.cfg.EmailFrom, a.cfg.EmailTo, msg); err != nil {
